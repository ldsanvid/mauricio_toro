...
from news_brief_mauricio_ejes_v9 import run_if_due as run_news_brief_if_due
import requests
...
def run_all_once() -> None:
    ...
    # Brief temático: 08:00, 12:00 y 18:00 hora Colombia.
    # OpenAI sólo se invoca cuando existe un corte pendiente.
    try:
